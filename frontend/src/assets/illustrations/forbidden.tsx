...
function ForbiddenIllustrationComponent({ hideBackground, sx, ...other }: SvgProps) {
  return (
    <SvgIcon
      viewBox="0 0 480 360"
    ...
    >
      ...
      <image href="/character-reject.webp" height="280" x="220" y="40" />
...
export const ForbiddenIllustration = memo(ForbiddenIllustrationComponent);
